...
# --- Ô NHẬP NGÀY IN ---
# Mặc định vẫn hiện ngày hôm nay để bạn đỡ phải gõ nếu là ngày hiện tại
ngay_mac_dinh = datetime.now().strftime("%d-%m")
ngay_nhap = st.sidebar.text_input("Nhập ngày in (VD: 13-04)", value=ngay_mac_dinh)

# Chuyển đổi đơn vị
pt_per_cm = 72 / 2.54
loai_bo_pt = loai_bo_cm * pt_per_cm

# TẠO TÊN FILE THEO NGÀY NHẬP
...
if uploaded_file is not None:
    try:
        ...
        # Hiển thị thông báo và nút tải với tên file tùy chỉnh
